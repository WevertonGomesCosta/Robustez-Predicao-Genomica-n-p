...
Este diretório armazenará os objetos derivados e os resultados científicos
necessários para reproduzir o tutorial sem repetir etapas computacionalmente
desnecessárias.
...
Logs, testes, execuções piloto e outros artefatos temporários não pertencem a
este diretório e serão armazenados localmente em `.local/`.
